...
<div class="section">
	...
	<?php p($l->t( "Your encryption keys are moved to a backup location. If soemthing went wrong you can restore the keys. Only delete them permanently if you are sure that all files are decrypted correctly." )); ?>
	<p>
		<button
			type="button"
